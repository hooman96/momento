      ...
      <div className="container mx-auto px-4 py-8">
        <div className='grid grid-cols-2 mb-8'>
          <div className='grid grid-cols-5'>
            {['All Posts', 'Stories', 'Articles', 'Updates', 'Migrations'].map((category) => (
              <div key={category} className='container mx-auto px-2 py-4 justify-center'>
                <div
                  className={`w-30 h-18 bg-gray-200 hover:bg-blue-500 transform hover:scale-105 transition duration-300 ease-in-out flex items-center justify-center font-semibold text-gray-800 hover:text-white rounded-lg shadow-md hover:shadow-lg ${selectedCategory === category && 'bg-blue-500 text-white'}`}
